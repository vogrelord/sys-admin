...
<head>
  ...
  <title>ООО « Системный администратор »</title>
...
<body>
  ...
  <div class="row page_wrap">
    ...
    <div class="">
        ...
        <div class="row head_row">
           <div ><h1 class=""><span class="heading_center_bg">ООО « Системный администратор »</span></h1>
            <div class='header-contacts'>
                <div class='mobile phone'><i class='fa fa-mobile'></i>Иван Говердовский (ген. директор): +7 (926) 218-33-40</div>
                <div class='phone'><i class='fa fa-phone'></i>Офис: +7 (901) 571-78-82</div>
      ...
      <div class="row advantages">
        <div class="three columns">
          ...
          <p> За более чем 5 лет работы на российском рынке <strong>ООО&nbsp;«Системный&nbsp;администратор»</strong> зарекомендовала себя, как устойчивая и динамично развивающаяся компания. </p>
        </div>
      ...
      <div class="row">
        <div class="twelve columns">
          <ul id="menu3" class="footer_menu horizontal">
            <li class=""><a href="index.html">Наверх</a></li>
          </ul>
      </div>
      </div>
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/javascripts/foundation.min.js" type="text/javascript">
</script> <!-- Initialize JS Plugins -->
     <script src="<?php echo Yii::app()->request->baseUrl; ?>/javascripts/app.js" type="text/javascript">
</script>
